...
export default function Carrito () {
    ...
    return (
        ...
        <div className='sorteo'>
            ...
            <br />
            <h2 className='titulosorteo2'>Nosotros en el calaboso del nerd "Escalibur" tratamos de que nuestros clientes se lleven la mejor experiencia con nostros, la mejor disposicion que podamos brindarle y para esto nosotros tenemos un sorteo bimestral en donde sortearemos juegos de play 5 o combos de indumentaria marca pacman old school, con este sorteo tratamos de darles el mimo que nuestros clientes merecen!! Lo que necesitan para entrar en el sorteo bimestral es llenar el formulario del sorteo con su respectivo Nombre, Email y comprar el "BONO DEL SORTEO" para que cualquier cliente alla o no comprado cualquier articulo pueda tener la posibilidad de participar en el sorteo Mucha Suerte Guerrero !!   </h2>
            <br />
